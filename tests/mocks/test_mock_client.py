...
class TestMockUSASpendingClient:
    ...
    def test_set_error_response(self):
        ...
        # Test 500 error
        client.set_error_response(
            "/test/500", error_code=500, error_message="Internal server error"
        )
    ...
    def test_assert_called_with(self):
        ...
        # Should pass
        client.assert_called_with("/test", method="POST", json={"key": "value"})
...
class TestResponseBuilder:
    ...
    def test_paginated_response(self):
        ...
        response = ResponseBuilder.paginated_response(
            results=[{"id": 1}, {"id": 2}], page=2, has_next=True
        )
    ...
    def test_award_search_response(self):
        ...
        response = ResponseBuilder.award_search_response(
            awards=[{"existing": "data"}, {"Award ID": "123", "other": "field"}]
        )
    ...
    def test_count_response(self):
        ...
        response = ResponseBuilder.count_response(contracts=100, grants=200, loans=50)
