...
def awards_search(mock_client):
    ...
    return AwardsSearch(mock_client).with_award_types("A")


class TestLimitFunctionality:
    """Test the limit() method properly limits total results."""
    
    def test_limit_stops_iteration_at_limit(self, awards_search, mock_client):
        """Test that limit() stops iteration at the specified number of items."""
        # Mock 3 pages with 10 items each
    ...
    def test_limit_less_than_page_size(self, awards_search, mock_client):
    ...
    def test_limit_exact_page_boundary(self, awards_search, mock_client):
    ...
    def test_limit_with_smaller_page_size(self, awards_search, mock_client):
    ...
    def test_limit_zero_returns_empty(self, awards_search, mock_client):
        ...
        assert mock_client._make_request.call_count == 0
    
    def test_no_limit_fetches_all(self, awards_search, mock_client):
...
class TestMaxPagesWithLimit:
    ...
    def test_limit_takes_precedence_over_max_pages(self, awards_search, mock_client):
    ...
    def test_max_pages_stops_before_limit(self, awards_search, mock_client):
...
class TestFirstMethodWithLimit:
    ...
    def test_first_uses_limit_one(self, awards_search, mock_client):
    ...
    def test_first_with_existing_limit(self, awards_search, mock_client):
...
class TestPageSizeFunctionality:
    ...
    def test_page_size_changes_request_limit(self, awards_search, mock_client):
    ...
    def test_page_size_capped_at_100(self, awards_search, mock_client):
    ...
    def test_effective_page_size_uses_smaller_of_limit_and_page_size(self, awards_search, mock_client):
        ...
        payload1 = mock_client._make_request.call_args[1]["json"]
        ...
        payload2 = mock_client._make_request.call_args[1]["json"]
        ...
        payload3 = mock_client._make_request.call_args[1]["json"]
...
class TestEmptyResults:
    ...
    def test_empty_first_page(self, awards_search, mock_client):
    ...
    def test_empty_page_stops_iteration(self, awards_search, mock_client):
