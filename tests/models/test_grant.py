...
class TestGrantSpecificProperties:
    ...
    def test_fain_property(self, mock_usa_client):
        """Test FAIN property."""
        data = {"generated_unique_award_id": "ASST_NON_123", "fain": "NNM11AA01A"}
        grant = Grant(data, mock_usa_client)
    ...
    def test_uri_property(self, mock_usa_client):
        """Test URI property."""
        data = {"generated_unique_award_id": "ASST_NON_123", "uri": "ABC123XYZ"}
        grant = Grant(data, mock_usa_client)
    ...
    def test_record_type_property(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "ASST_NON_123", "record_type": 2}
        grant = Grant(data, mock_usa_client)
    ...
    def test_cfda_number(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "ASST_NON_123", "cfda_number": "43.008"}
        grant = Grant(data, mock_usa_client)
    ...
    def test_cfda_number_search_results(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "ASST_NON_123", "CFDA Number": "43.008"}
        grant = Grant(data, mock_usa_client)
    ...
    def test_cfda_info_property(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "ASST_NON_123", "cfda_info": cfda_data}
        grant = Grant(data, mock_usa_client)
    ...
    def test_sai_number(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "ASST_NON_123", "sai_number": "SAI EXEMPT"}
        grant = Grant(data, mock_usa_client)
    ...
    def test_sai_number_search_results(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "ASST_NON_123", "SAI Number": "SAI EXEMPT"}
        grant = Grant(data, mock_usa_client)
...
class TestGrantWithRealFixtureData:
    ...
    def test_grant_fixture_properties(self, mock_usa_client, grant_fixture_data):
        ...
        assert (
            ...
            == grant_fixture_data["transaction_obligated_amount"]
        )

        # Test CFDA info
        assert len(grant.cfda_info) == len(grant_fixture_data["cfda_info"])
        assert (
            grant.cfda_info[0]["cfda_number"]
            == grant_fixture_data["cfda_info"][0]["cfda_number"]
        )
        assert (
            grant.cfda_info[1]["cfda_number"]
            == grant_fixture_data["cfda_info"][1]["cfda_number"]
        )
