...
class TestAwardAgencyIntegration:
    ...
    def test_award_agencies_with_search_results_structure(self, mock_usa_client, search_results_contracts_data):
        ...
        assert funding_agency.abbreviation == search_results_data["Funding Agency Code"]  # Uses code as abbreviation in flat structure
    ...
    def test_award_agencies_with_comprehensive_flat_data_structure(self, mock_usa_client, search_results_contracts_data):
