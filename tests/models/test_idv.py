...
class TestIDVSpecificProperties:
    ...
    def test_piid_property(self, mock_usa_client):
        """Test PIID property."""
        data = {"generated_unique_award_id": "CONT_IDV_123", "piid": "80JSC019C0012"}
        idv = IDV(data, mock_usa_client)
    ...
    def test_psc_properties(self, mock_usa_client):
        ...
        data = {
            "generated_unique_award_id": "CONT_IDV_123",
            "psc": {"code": "1555", "description": "SPACE VEHICLES"},
        }
        idv = IDV(data, mock_usa_client)
...
class TestIDVCachedProperties:
    ...
    def test_psc_hierarchy(self, mock_usa_client):
        ...
        psc_data = {
            ...
            "base_code": {"code": "1555", "description": "SPACE VEHICLES"},
        }
        data = {"generated_unique_award_id": "CONT_IDV_123", "psc_hierarchy": psc_data}
        idv = IDV(data, mock_usa_client)
...
class TestIDVWithRealFixtureData:
    ...
    def test_idv_fixture_properties(self, mock_usa_client, idv_fixture_data):
        ...
        assert (
            idv.latest_transaction_contract_data["idv_type_description"]
            == idv_fixture_data["latest_transaction_contract_data"][
                "idv_type_description"
            ]
        )
        assert (
            idv.latest_transaction_contract_data["solicitation_identifier"]
            == idv_fixture_data["latest_transaction_contract_data"][
        ...
        assert (
            idv.psc_hierarchy["midtier_code"]["code"]
            == idv_fixture_data["psc_hierarchy"]["midtier_code"]["code"]
        )
        assert (
            idv.naics_hierarchy["base_code"]["code"]
            == idv_fixture_data["naics_hierarchy"]["base_code"]["code"]
        )
