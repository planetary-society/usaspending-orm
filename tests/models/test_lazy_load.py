...
class TestLazyRecord:
    ...
    def test_lazy_record(self, mock_client):
        ...
        class TestRecord(LazyRecord):
            def _fetch_details(self):
                return {"detail_field": "detail_value", "existing_field": "updated_value"}
        
        return TestRecord({"existing_field": "original_value", "empty_string_field":""}, mock_client)
    ...
    def test_lazy_get_triggers_ensure_details_when_key_is_none_and_not_detailed_fetched(self, test_lazy_record):
