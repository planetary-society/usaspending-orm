...
class TestAgencySubagencies:
    ...
    def test_subagencies_property_with_offices(
        self, mock_usa_client, agency_subagencies_fixture_data
    ):
    ...
    def test_subagencies_property_api_error(self, mock_usa_client):
        ...
        mock_usa_client.set_error_response(
            "/agency/080/sub_agency/", error_code=500, error_message="API Error"
        )

        agency_data = {"code": "080", "toptier_code": "080", "name": "Test Agency"}
    ...
    def test_subagencies_property_uses_fiscal_year(
        self, mock_usa_client, agency_subagencies_fixture_data
    ):
    ...
    def test_subagencies_property_no_fiscal_year(
        self, mock_usa_client, agency_subagencies_fixture_data
    ):
    ...
    def test_subagencies_property_empty_results(self, mock_usa_client):
        ...
        agency_data = {"code": "080", "name": "Test Agency"}
