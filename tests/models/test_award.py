...
class TestAwardFetchDetails:
    ...
    def test_fetch_details_api_exception(self, mock_usa_client):
        ...
        mock_usa_client.set_error_response(
            "/v2/awards/CONT_AWD_123/", 500, error_message="Internal Server Error"
        )
...
class TestAwardPropertiesWithRealData:
    ...
    def test_generated_unique_award_id_property(
        self, mock_usa_client, award_fixture_data
    ):
    ...
    def test_period_of_performance_from_real_data(
        self, mock_usa_client, award_fixture_data
    ):
...
class TestAwardHelperMethods:
    ...
    def test_usa_spending_url_property_with_real_data(
        self, mock_usa_client, award_fixture_data
    ):
...
class TestAwardTransactions:
    ...
    def test_transactions_current_implementation_with_real_data(
        self, mock_usa_client, award_fixture_data
    ):
        ...
        mock_usa_client.mock_transactions_for_award(
            award_id, fixture_name="awards/transactions"
        )
        ...
        mock_transactions = [Transaction(result) for result in response["results"]]
        ...
        mock_transactions_resource.for_award.assert_called_once_with(
            "CONT_AWD_80GSFC18C0008_8000_-NONE-_-NONE-"
        )
    ...
    def test_transactions_property_returns_query_builder(
        self, mock_usa_client, award_fixture_data
    ):
        ...
        mock_transactions_resource.for_award.assert_called_with(
            "CONT_AWD_80GSFC18C0008_8000_-NONE-_-NONE-"
        )
...
class TestAwardTypeInformation:
    ...
    def test_award_type_information_from_real_data(
        self, mock_usa_client, award_fixture_data
    ):
    ...
    def test_recipient_property_is_cached(self, mock_usa_client):
        ...
        award_data = {
            ...
            "recipient": {
                ...
                "location": {"country_name": "UNITED STATES", "state_code": "CA"},
            },
        }
...
class TestAwardAgencyProperties:
    ...
    def test_funding_agency_property(self, mock_usa_client):
        ...
        data = {"generated_unique_award_id": "AWARD_123", "funding_agency": agency_data}
        award = Award(data, mock_usa_client)
    ...
    def test_funding_agency_cached(self, mock_usa_client):
        ...
        agency_data = {"id": 862, "toptier_agency": {"name": "NASA", "code": "080"}}
        data = {"generated_unique_award_id": "AWARD_123", "funding_agency": agency_data}
        award = Award(data, mock_usa_client)
...
class TestAwardExecutiveDetailsProperty:
    ...
    def test_executive_details_property(self, mock_usa_client):
        ...
        executive_data = {
            "officers": [
                {"name": "GWYNNE SHOTWELL", "amount": 4077012.0},
                {"name": "BRET JOHNSEN", "amount": 3079137.0},
